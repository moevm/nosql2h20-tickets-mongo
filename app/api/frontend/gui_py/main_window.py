...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("./frontend/resources/plane.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.plane_2.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("./frontend/resources/train.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.train_2.setIcon(icon4)
